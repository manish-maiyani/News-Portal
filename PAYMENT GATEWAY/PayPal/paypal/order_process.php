...
define('RETURN_URL', 'http://localhost:8083/paypal/order_process.php'); //return URL where PayPal redirects user
define('CANCEL_URL', 'http://localhost:8083/paypal/payment_cancel.html'); //cancel URL
...
if(isset($_SESSION["results"]))
{
	...
	mysqli_query($mysqli,"INSERT INTO paypal(Tran_ID, DT, Currency, Amount, Method)
