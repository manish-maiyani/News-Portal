...
define('CLIENT_ID', 'AVW7GqLdj9P8L0783fT6E-8bi8kExQPjaVgu-6mT0LVURPbsZtH3Tunk5DoHe-wWF7DpuuMHefxICsNd'); //your PayPal client ID
define('CLIENT_SECRET', 'EFRD8zft6tibIbhWJoWdBTWS9H_KilYfkm1Y0ZVXaE8JIHBUg4aeuSk5BsFEn8zyE6BdudVYcrSQ8WJJ'); //PayPal Secret
define('RETURN_URL', 'http://newsportal66.000webhostapp.com/paypal/order_process.php'); //return URL where PayPal redirects user
define('CANCEL_URL', 'http://newsportal66.000webhostapp.com/paypal/payment_cancel.html'); //cancel URL
...
if(isset($_SESSION["results"]))
{
	...
	mysqli_query($mysqli,"INSERT INTO paypal(Tran_ID, DT, Currency, Amount, Method, State)
														VALUES ('".$_SESSION["results"]["transaction_id"]."','".$_SESSION["results"]["transaction_time"]."','".$_SESSION["results"]["transaction_currency"]."','".$_SESSION["results"]["transaction_amount"]."','".$_SESSION["results"]["transaction_method"]."','".$_SESSION["results"]["transaction_state"]."')");
