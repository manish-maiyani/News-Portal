    ...
    <ul>
        ...
        <li>
            ...
            <div class="btn-wrap">
                ...
                <input type="hidden" name="item_price" value="3" />
                <input type="submit" value="Buy 3" />
                </form>
            </div>
        </li>
    </ul>
...
<br><br><br>
<a href="refund.php"><font color="red"><h1>REFUND</h1></font></a>
